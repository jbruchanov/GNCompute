...
import com.scurab.gncompute.ext.toVec3
import com.scurab.gncompute.model.AtomicCounters
...
class GLCompute(private val dispatcher: CoroutineDispatcher = defaultDispatcher) : CoroutineScope {
    ...
    companion object {
        ...
        private val defaultDispatcher: CoroutineDispatcher = newFixedThreadPoolContext(1, "Default-gncompute")
