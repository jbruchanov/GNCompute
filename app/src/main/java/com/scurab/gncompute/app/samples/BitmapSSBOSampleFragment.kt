...
import com.scurab.gncompute.app.databinding.FragmentBitmapSsboBinding
import com.scurab.gncompute.app.gncompute
import com.scurab.gncompute.app.tools.viewLifecycleLazy
import com.scurab.gncompute.gl.SampleBitmapProgram
...
class BitmapSSBOSampleFragment : Fragment(R.layout.fragment_bitmap_ssbo) {
    ...
    private fun subscribeChannel(debounce: Long) {
        ...
        sliderSubscription = lifecycleScope.launch(gncompute.coroutineContext) {
